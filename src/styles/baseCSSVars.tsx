...
const baseCSSVars = css`
  ...
  /* Font families */
  --base-font-family: 'Roboto Mono', 'Arial', 'Helvetica Neue', 'Helvetica', sans-serif;
  --base-font-family-title: 'Druk Heavy', 'Impact', 'Arial', 'Helvetica Neue', 'Helvetica', sans-serif;
  --base-font-family-button: 'Druk Wide', 'Impact', 'Arial', 'Helvetica Neue', 'Helvetica', sans-serif;
  --base-font-family-code: 'Courier New', monospace;
